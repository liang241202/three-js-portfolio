      ...
      return (
        <group>
          ...
          <mesh position={[0, 1.95, 0]} castShadow>
            ...
            <meshStandardMaterial color="#ff5566" emissive="#ff2233" emissiveIntensity={0.7} />
          </mesh>
        </group>
      );
    case "project-01":
      ...
      return (
        <group>
          ...
          <mesh position={[0, 0.95, 0.28]} castShadow>
            ...
            <meshStandardMaterial color="#1e2630" emissive="#7fd1c0" emissiveIntensity={0.5} />
          </mesh>
        </group>
      );
    case "about-grove":
      ...
      return (
        <group>
          ...
          <mesh position={[0, 0.32, 0]}>
            ...
            <meshStandardMaterial color="#2a2333" emissive="#9b7bff" emissiveIntensity={0.55} />
          </mesh>
